...
export function TracksSection() {
  ...
  // On mobile, render without motion components
  if (isMobile) {
    return (
              ...
              return (
                <div key={track.slug}>
                  <Link href={`/tracks/${track.slug}`} className="block h-full">
                    <div className="group relative h-full bg-card border-2 border-border rounded-3xl p-8 cursor-pointer hover:border-transparent hover:shadow-2xl transition-all duration-500 overflow-hidden">
                      {/* Hover Gradient */}
                      ...
                      <div className="relative z-10">
                        {/* Icon */}
                        <div className={`w-16 h-16 rounded-2xl ${track.iconBg} flex items-center justify-center mb-6`}>
                        ...
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className={`w-8 h-8 rounded-xl bg-gradient-to-br ${track.gradient} flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 shrink-0`}>
