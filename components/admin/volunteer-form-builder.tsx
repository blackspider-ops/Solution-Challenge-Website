...
} from "@/lib/actions/volunteer-form-builder";
...
export function VolunteerFormBuilder({ sections: initialSections }: { sections: Section[] }) {
  ...
  function confirmDeleteSection() {
    ...
    deleteVolunteerSection(sectionToDelete).then((result) => {
      if ("error" in result) {
  ...
  function confirmDeleteQuestion() {
    ...
    deleteVolunteerQuestion(questionToDelete).then((result) => {
      if ("error" in result) {
        toast.error(result.error);
      } else {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(active) => {
                        updateVolunteerSection(section.id, { active }).then((result) => {
                          if ("error" in result) {
                            toast.error(result.error);
                          } else {
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex items-center gap-1 shrink-0">
            <Switch
              ...
              onCheckedChange={(active) => {
                updateVolunteerQuestion(question.id, { active }).then((result) => {
                  if ("error" in result) {
                    toast.error(result.error);
                  } else {
                    onUpdate({ active });
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = section
        ? await updateVolunteerSection(section.id, formData)
        : await createVolunteerSection(formData);
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      const result = question
        ? await updateVolunteerQuestion(question.id, data)
        : await createVolunteerQuestion(data);
